...
res_list = [144, 240, 360, 480, 720, 1080, 1440, 2160]  # List with valid YT resolutions
...
def is_resolution(resolution: str) -> int:
    """
    ...
    if value not in res_list:
        msg = "%r is not a valid resolution" % resolution
